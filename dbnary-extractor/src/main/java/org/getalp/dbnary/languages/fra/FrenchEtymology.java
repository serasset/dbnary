...
public class FrenchEtymology {
  ...
  static {
    ...
    tmp.put("INHERITANCE", Arrays.asList("[Dd]e", "[Dd]u", "[Dd]epuis", "[iI]ssue d[eu]"));
    tmp.put("BORROWING", Arrays.asList("[Ee]mprunt[*]", "[Cc]alqu[*]"));
  ...
  private void finishFSymbols(FSymbols fsymbols) {
    WikiText t = new WikiText(pageName);
    System.out.println(t.toString());

  }


  public String getWordFromTemplateList(List<WikiText.Template> templates) throws Exception {
  ...
  public String getTemplateWord(WikiText.Template t) throws Exception {
    switch (t.getName()) {
      case "étyl":
        try {
      ...
      default:
        throw new Exception("template non recon");
