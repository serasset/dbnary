...
public class WiktionaryDataHandler extends OntolexBasedRDFDataHandler {
  ...
  static {
     ...
     * ===Konjunktion===
     *
     * ===Interjektion=== ===Pronomen=== ===Artikel=== ===Verbpartikel=== ===Partikel=== ===Talesätt===
     * ===Ordspråk=== ===Förkortning===
     *
     * ===Affix=== ===Förled=== ===Efterled=== ===Fras=== ===Tecken=== ===Kod=== ===Cirkumposition===
     * ===Postposition=== ===Räknemarkör=== ===Infinitivmärke=== ===Transkription=== ===Subjunktion===
     */
    // swedish
    ...
    posAndTypeValueMap.put("Konjunktion", new PosAndType(LexinfoOnt.subordinatingConjunction, LexinfoOnt.Conjunction));
    ...
    posAndTypeValueMap.put("Infinitivmärke", new PosAndType(LexinfoOnt.infinitiveParticle, LexinfoOnt.Particle));
    posAndTypeValueMap.put("Verbpartikel", new PosAndType(LexinfoOnt.particle, LexinfoOnt.Particle));
    posAndTypeValueMap.put("Preposition", new PosAndType(LexinfoOnt.preposition, LexinfoOnt.Preposition));
    posAndTypeValueMap.put("Cirkumposition", new PosAndType(LexinfoOnt.circumposition, LexinfoOnt.Adposition));
    ...
    posAndTypeValueMap.put("Fras", new PosAndType(LexinfoOnt.phraseologicalUnit, OntolexOnt.MultiWordExpression));
    posAndTypeValueMap.put("Talesätt", new PosAndType(LexinfoOnt.idiom, OntolexOnt.MultiWordExpression));
    posAndTypeValueMap.put("Förkortning", new PosAndType(LexinfoOnt.abbreviation, OntolexOnt.LexicalEntry));
    posAndTypeValueMap.put("Kod", new PosAndType(LexinfoOnt.symbol, OntolexOnt.LexicalEntry));
    posAndTypeValueMap.put("Räknemarkör", new PosAndType(OliaOnt.Classifier, OntolexOnt.LexicalEntry));
    posAndTypeValueMap.put("Transkription", new PosAndType(LexinfoOnt.transcribedForm, OntolexOnt.LexicalEntry));
  ...
  public static boolean isValidPOS(String pos) {
    return posAndTypeValueMap.containsKey(pos) ? true : posAndTypeValueMap.containsKey(pos.split("[\\s\\p{Punct}]+")[0]);
  }
