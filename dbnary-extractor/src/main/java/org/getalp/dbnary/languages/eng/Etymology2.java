...
import static org.getalp.dbnary.languages.eng.StaticEtymologyRessources.bulletSymbolsList;
...
public class Etymology2 {


  static Logger log = LoggerFactory.getLogger(Etymology.class);
  static StaticEtymologyRessources staticEtymologyRessources = new StaticEtymologyRessources();
  public String lang;
  public String string;
  public ArrayList<Symbols> symbols;

  public Etymology2(String s, String l) {
    string = s;
    lang = l;
  ...
  public void fromTableToSymbols() {
    ...
    toSymbols(staticEtymologyRessources.bulletSymbolsList, staticEtymologyRessources.bulletSymbolsListPattern);

    ArrayList<Symbols> lemmas = new ArrayList<>();
    Matcher m = staticEtymologyRessources.tableDerivedLemmasPattern.matcher(toString(symbols));
    while (m.find()) {
  ...
  public void fromDefinitionToSymbols() {
    ...
    toSymbols(staticEtymologyRessources.definitionSymbolsList, staticEtymologyRessources.definitionSymbolsListPattern);
    ...
    ArrayList<Span> m = findMatch(symbols, staticEtymologyRessources.definitionSymbolsPattern);
    if (m.size() == 0) {
  ...
  public void fromBulletToSymbols() {
    ...
    toSymbols(bulletSymbolsList, staticEtymologyRessources.bulletSymbolsListPattern);
    ...
    ArrayList<Symbols> lemmas = new ArrayList<>();
    Matcher m = staticEtymologyRessources.bulletSymbolsPattern.matcher(toString(symbols));
    while (m.find()) {
  ...
  public void parseMultipleBorrowing() {
    ArrayList<Span> match = findMatch(symbols, staticEtymologyRessources.multipleBorrowingSymbolsPattern);
  ...
  public void parseCompound() {
    ...
    ArrayList<Span> match = findMatch(symbols, staticEtymologyRessources.compoundSymbolsPattern);
