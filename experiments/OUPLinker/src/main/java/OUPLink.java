 ...
 */
public class OUPLink {

    public static final Logger logger = org.slf4j.LoggerFactory.getLogger(OUPLink.class);
    ...
    private void loadArgs(String[] args) {
        ...
        if (	outputFormat.equals("RDF") ||
            ...
            lexinfoPOS = oup.getProperty("http://www.lexinfo.net/ontology/2.0/lexinfo#partOfSpeech");

            links = ModelFactory.createDefaultModel();

            // Load wordnet model

            System.err.println("Reading OUP model from " + remainingArgs[0]);
