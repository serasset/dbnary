					...
					if(matcher.group(5) != null ){
						...
						if(matcher.group(7) != null){
							...
							if(hmn.containsKey(matcher.group(9))&& hmn.containsKey(matcher.group(10))) {
								...
								if(hmn.get(matcher.group(9)).getnf() != null)model.add( n1,nf, model.createLiteral(hmn.get(matcher.group(9)).getnf()));
								...
								if(hmn.get(matcher.group(10)).getnf() != null)model.addLiteral( n2,nf, model.createLiteral(""+hmn.get(matcher.group(10)).getnf()));
								
								//CREATION D'UNE RELATION
								model.add(model.createStatement(n1,hmp.get(matcher.group(11)),n2));
