 ...
 * @author serasset
 */
public class WiktionaryExtractorOld extends AbstractWiktionaryExtractor {

  private Logger log = LoggerFactory.getLogger(WiktionaryExtractorOld.class);
  ...
  public WiktionaryExtractorOld(IWiktionaryDataHandler wdh) {
    super(wdh);
  }
