...
\textbf{Source/Target} & \textbf{deu} & \textbf{eng} & \textbf{fin} & \textbf{fra} & \textbf{ita} & \textbf{por}& \textbf{others} & \textbf{Total} \\
\textbf{eng} & 56880 & 1 & 70803 & 53702 & 36009 & 28049 & 775986 & 1021430\\
\end{tabular}
\caption{Number of translation equivalents in each language edition, detailed by target language.}\label{tradsize}
\end{table*}
