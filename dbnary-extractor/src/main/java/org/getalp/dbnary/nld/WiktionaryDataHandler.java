...
public class WiktionaryDataHandler extends OntolexBasedRDFDataHandler {
    ...
    static {
        ...
        // DONE: dutch POS
        posAndTypeValueMap.put("abbr", new PosAndType(LexinfoOnt.abbreviation, LexinfoOnt.AbbreviatedForm));
        ...
        posAndTypeValueMap.put("circumf", new PosAndType(LexinfoOnt.circumposition, LexinfoOnt.Adposition));
        posAndTypeValueMap.put("conj", new PosAndType(LexinfoOnt.conjunction, LexinfoOnt.Conjunction));
        posAndTypeValueMap.put("cont", new PosAndType(LexinfoOnt.contraction, LexinfoOnt.AbbreviatedForm));
        // not for Dutch...
        ...
        posAndTypeValueMap.put("interj", new PosAndType(LexinfoOnt.interjection, LexinfoOnt.Interjection));
        ...
        posAndTypeValueMap.put("num-indef", new PosAndType(LexinfoOnt.indefiniteCardinalNumeral, LexinfoOnt.Numeral));
        posAndTypeValueMap.put("num-int", new PosAndType(LexinfoOnt.interrogativeCardinalNumeral, LexinfoOnt.Numeral));
        // Not for Dutch
        // posAndTypeValueMap.put("num-srt", new PosAndType(LexinfoOnt., OntolexOnt.LexicalEntry));
        posAndTypeValueMap.put("ordn", new PosAndType(LexinfoOnt.ordinalAdjective, LexinfoOnt.Adjective));
        posAndTypeValueMap.put("ordn-indef", new PosAndType(LexinfoOnt.indefiniteOrdinalNumeral, LexinfoOnt.Numeral));
        posAndTypeValueMap.put("prcp", new PosAndType(LexinfoOnt.participleAdjective, LexinfoOnt.Adjective));
        posAndTypeValueMap.put("phrase", new PosAndType(LexinfoOnt.phraseologicalUnit, OntolexOnt.MultiWordExpression));
        posAndTypeValueMap.put("post", new PosAndType(LexinfoOnt.postposition, LexinfoOnt.Postposition));
        ...
        posAndTypeValueMap.put("pron-adv", new PosAndType(LexinfoOnt.adverbialPronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-dem", new PosAndType(LexinfoOnt.demonstrativePronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-excl", new PosAndType(LexinfoOnt.exclamativePronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-indef", new PosAndType(LexinfoOnt.indefinitePronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-int", new PosAndType(LexinfoOnt.interrogativePronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-pers", new PosAndType(LexinfoOnt.personalPronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-pos", new PosAndType(LexinfoOnt.possessivePronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-rec", new PosAndType(LexinfoOnt.reciprocalPronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-refl", new PosAndType(LexinfoOnt.reflexivePersonalPronoun, LexinfoOnt.Pronoun));
        posAndTypeValueMap.put("pronom-rel", new PosAndType(LexinfoOnt.relativePronoun, LexinfoOnt.Pronoun));
        // posAndTypeValueMap.put("pronom-temp", new PosAndType(LexinfoOnt.noun, LexinfoOnt.LexicalEntry));
    ...
    public void addPartOfSpeech(String pos) {
        ...
        currentSenseNumber = 0; currentSubSenseNumber = 0;
