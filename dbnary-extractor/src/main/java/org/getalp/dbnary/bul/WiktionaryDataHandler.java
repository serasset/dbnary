...
public class WiktionaryDataHandler extends OntolexBasedRDFDataHandler {
  ...
  static {
    ...
    posAndTypeValueMap
        .put("Съществително нарицателно име", new PosAndType(LexinfoOnt.noun, LexinfoOnt.Noun));
    posAndTypeValueMap.put("Съществително собствено име",
        new PosAndType(LexinfoOnt.properNoun, LexinfoOnt.ProperNoun));

    posAndTypeValueMap
        .put("Прилагателно име", new PosAndType(LexinfoOnt.adjective, LexinfoOnt.Adjective));
    ...
    posAndTypeValueMap
        .put("Числително име", new PosAndType(LexinfoOnt.numeral, LexinfoOnt.Numeral));

    posAndTypeValueMap.put("Частица", new PosAndType(LexinfoOnt.particle, LexinfoOnt.Particle));

    posAndTypeValueMap
        .put("Предлог", new PosAndType(LexinfoOnt.preposition, LexinfoOnt.Preposition));
  }
