...
//    definitionExtractor = new ChineseDefinitionExtractorWikiModel(wdh,wi,new Locale("zh"),"--DO NOT USE IMAGE BASE URL FOR DEBUG--", "");
//  }
      ...
      switch (state) {
        case NODATA:
          if (isTranslation(m)) {
            ...
            System.out.println("block named " +m.group(1)+" is ignored");
            gotoNoData(m);
          }
          break;
