...
/**
 * @author serasset Support class for ISO 639-3 standard for language naming. <p> This class is
 * designed to be used as a singleton. <p> Usage: <code>ISO639_3 isoLanguages =
...
public class ISO639_3 {
  ...
  private ISO639_3() {
    ...
    try {
      ...
      if (fis == null) {
        throw new IOException("ISO639 French data not available");
      }
      BufferedReader br = new BufferedReader(new InputStreamReader(fis, "UTF-8"));
