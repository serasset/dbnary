...
public class WiktionaryDataHandler extends OntolexBasedRDFDataHandler {
  ...
  static {
    ...
    posAndTypeValueMap
        .put("Adjektiv", new PosAndType(LexinfoOnt.adjective, OntolexOnt.LexicalEntry));  //fait
    posAndTypeValueMap
    ...
    posAndTypeValueMap
        .put("Preposition", new PosAndType(LexinfoOnt.preposition, LexinfoOnt.Preposition)); //fait
    posAndTypeValueMap
    ...
    posAndTypeValueMap
        .put("Ordspråk", new PosAndType(LexinfoOnt.proverb, OntolexOnt.MultiWordExpression)); //fait
