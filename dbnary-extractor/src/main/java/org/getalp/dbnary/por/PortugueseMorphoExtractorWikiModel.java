...
public class PortugueseMorphoExtractorWikiModel extends DbnaryWikiModel {
  ...
  public PortugueseMorphoExtractorWikiModel(IWiktionaryDataHandler we, Locale locale,
      String imageBaseURL, String linkBaseURL) {
    this(we, (WiktionaryIndex) null, locale, imageBaseURL, linkBaseURL);
  }

  public PortugueseMorphoExtractorWikiModel(IWiktionaryDataHandler we, WiktionaryIndex wi,
