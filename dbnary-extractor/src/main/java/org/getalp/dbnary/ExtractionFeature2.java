...
public abstract class ExtractionFeature2 {
  ...
  public static final ExtractionFeature2 MORPHOLOGY_EXOLEX = new ExtractionFeature2(MORPHOLOGY, true) {};
  public static final Consumer<Set<ExtractionFeature2>> enableMorphology = s -> s.add(MORPHOLOGY_ENDOLEX);
  public static final Consumer<Set<ExtractionFeature2>> enableMorphologyExolex = s -> s.add(MORPHOLOGY_EXOLEX);

  public static final ExtractionFeature2 ETYMOLOGY_ENDOLEX = new ExtractionFeature2(ETYMOLOGY) {};
  public static final ExtractionFeature2 ETYMOLOGY_EXOLEX = new ExtractionFeature2(ETYMOLOGY, true) {};
  public static final Consumer<Set<ExtractionFeature2>> enableEtymology = s -> s.add(ETYMOLOGY_ENDOLEX);
  public static final Consumer<Set<ExtractionFeature2>> enableEtymologyExolex = s -> s.add(ETYMOLOGY_EXOLEX);
  ...
  public static final ExtractionFeature2 ENHANCEMENT_ENDOLEX = new ExtractionFeature2(ENHANCEMENT) {};
  public static final ExtractionFeature2 ENHANCEMENT_EXOLEX = new ExtractionFeature2(ENHANCEMENT, true) {};
  public static final Consumer<Set<ExtractionFeature2>> enableEnhancement = s -> s.add(ENHANCEMENT_ENDOLEX);
  public static final Consumer<Set<ExtractionFeature2>> enableEnhancementExolex = s -> s.add(ENHANCEMENT_EXOLEX);

  public static final ExtractionFeature2 STATISTICS_ENDOLEX = new ExtractionFeature2(STATISTICS) {};
  public static final ExtractionFeature2 STATISTICS_EXOLEX = new ExtractionFeature2(STATISTICS, true) {};
  public static final Consumer<Set<ExtractionFeature2>> enableStatistics = s -> s.add(STATISTICS_ENDOLEX);
  public static final Consumer<Set<ExtractionFeature2>> enableStatisticsExolex = s -> s.add(STATISTICS_EXOLEX);
