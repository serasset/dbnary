...
public class ChineseDbnaryExtractorWikiModel extends DbnaryWikiModel {
  public ChineseDbnaryExtractorWikiModel(WiktionaryPageSource wi, Locale locale,
  ...
  public String getRawWikiContent(ParsedPageName parsedPagename, Map<String, String> map)
    ...
    if ((parsedPagename.namespace.isType((INamespace.NamespaceCode.TEMPLATE_NAMESPACE_KEY))
        || parsedPagename.namespace.isType(INamespace.NamespaceCode.MODULE_NAMESPACE_KEY))
