...
/**
 * An abstract class gathering all common arguments of the main extraction command lines. Created by
 * serasset on 17/07/17.
 *
 * @deprecated
 */
  ...
  protected void loadArgs(String[] args) throws WiktionaryIndexerException {
    ...
    if (outputFormat.equals("RDF") || outputFormat.equals("TURTLE")
      ...
      if (morphoOutputFile != null) {
        wdh.enableFeature(IWiktionaryDataHandler.Feature.MORPHOLOGY);
      }
      if (etymologyOutputFile != null) {
        wdh.enableFeature(IWiktionaryDataHandler.Feature.ETYMOLOGY);
      }
    } else {
