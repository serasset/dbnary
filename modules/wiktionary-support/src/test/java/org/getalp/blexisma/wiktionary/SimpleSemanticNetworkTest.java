...
import org.getalp.blexisma.wiktionary.SimpleSemanticNetwork.Relation;
...
public class SimpleSemanticNetworkTest {
    ...
    public void testAddNode() {
        ...
        assertEquals(sn1.getEdges("Origin").size(), 1);
        
        sn1.addRelation(s, s2, 1, "y");

        assertEquals(sn1.getEdges("Origin").size(), 2);
