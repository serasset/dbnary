...
public class WiktionaryDataHandler extends OntolexBasedRDFDataHandler {
    ...
    static {
        ...
        posAndTypeValueMap
                .put("Adverb", new PosAndType(LexinfoOnt.adverb, OntolexOnt.LexicalEntry));
        ...
        posAndTypeValueMap
                .put("Particle", new PosAndType(LexinfoOnt.particle, LexinfoOnt.Particle));
    ...
    public void uncountable() {
        ...
        aBox.add(aBox.createStatement(currentLexEntry, OliaOnt.hasCountability,
                OliaOnt.Uncountable));
    }
    ...
    public void registerWikisaurusNym(String currentPOS, String currentWS, String currentNym,
        ...
        gloss = DatatypeConverter
                .printBase64Binary(BigInteger.valueOf(gloss.hashCode()).toByteArray())
                .replaceAll("[/=\\+]", "-");
        Resource glossResource = getGlossForWikisaurus(gloss);
        if (null != currentPOS) {
            aBox.add(
                    aBox.createStatement(glossResource, DBnaryOnt.partOfSpeech,
                            posResource(currentPOS)));
        }
        if (null != currentWS) {
        ...
        ReifiedStatement rnymR =
                nymR.createReifiedStatement(
                        computeNymId(currentNym, uriEncode(currentWiktionaryPageName)));
