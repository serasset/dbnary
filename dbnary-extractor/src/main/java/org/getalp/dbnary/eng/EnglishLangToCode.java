...
public class EnglishLangToCode extends LangTools {
    ...
    static {
	//THIS LIST HAS BEEN REDUCED TO THOSE LANGUAGES THAT ARE NOT ALREADY INCLUDED IN FILE LIST_OF_LANGUAGES.CSV
	...
	//////corresponds to languages: Rwanda-Rundi, Rwanda, Kinyarwanda, Rundi, Kirundi, Ha, Giha, Hangaza, Vinza, Shubi, Subi
	...
	//E.g.:
	//add("Bikol","bik"); //this is probably incorrect. it is not present in file list_of_languages.cs but bikol as bik is a MacroLanguage
	//E.g.:
	...
	//many entries that were present below are present in file etymology-only_languages.csv but have changed over time
	...
	//add("Old Gujarati", "gu-old");//this is not present in file etymology-only_languages.csv anymore
