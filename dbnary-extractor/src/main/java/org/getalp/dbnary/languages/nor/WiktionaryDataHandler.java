...
public class WiktionaryDataHandler extends OntolexBasedRDFDataHandler {
  ...
  public void addPOSinfo(String s) {
    ...
    if (infos.length > 0) {
      if (infos[0].equals("se også") || infos[0].contains("wikipedia") || infos[0].equalsIgnoreCase("grunnstoffer") || infos[0].equalsIgnoreCase("andre former")
          || infos[0].equalsIgnoreCase("verb-no") || infos[0].contains("feilstaving") || infos[0].contains("bøyningsform") || infos[0].contains("-et")) {
        return;
      }
