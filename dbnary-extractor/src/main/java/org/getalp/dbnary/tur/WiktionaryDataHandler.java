...
public class WiktionaryDataHandler extends OntolexBasedRDFDataHandler {
  ...
  static {
    ...
    posAndTypeValueMap
        .put("Atasözü", new PosAndType(LexinfoOnt.proverb, OntolexOnt.MultiWordExpression));
    posAndTypeValueMap
        .put("Bağlaç", new PosAndType(LexinfoOnt.conjunction, OntolexOnt.LexicalEntry));
    ...
    posAndTypeValueMap
        .put("Kısaltma", new PosAndType(LexinfoOnt.abbreviation, OntolexOnt.LexicalEntry));
    ...
    posAndTypeValueMap
        .put("Özel Ad", new PosAndType(LexinfoOnt.properNoun, OntolexOnt.LexicalEntry));
    posAndTypeValueMap
        .put("Özel ad", new PosAndType(LexinfoOnt.properNoun, OntolexOnt.LexicalEntry));
    ...
    posAndTypeValueMap
        .put("Sözce", new PosAndType(LexinfoOnt.expression, OntolexOnt.MultiWordExpression));
    posAndTypeValueMap
        .put("Ünlem", new PosAndType(LexinfoOnt.interjection, OntolexOnt.LexicalEntry));
    ...
    posAndTypeValueMap
        .put("Eylem (basit)", new PosAndType(LexinfoOnt.verb, OntolexOnt.LexicalEntry));
