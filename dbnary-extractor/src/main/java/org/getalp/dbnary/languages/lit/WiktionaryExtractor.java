package org.getalp.dbnary.languages.lit;
...
public class WiktionaryExtractor extends AbstractWiktionaryExtractor {
  ...
  private enum Block {
    NOBLOCK, IGNOREPOS, DEFBLOCK, NYMBLOCK, TRADBLOCK, PRONBLOCK, RELATEDTERMBLOCK, EXAMPLEBLOCK
  }
  ...
  protected void extractDataLang(int startOffset, int endOffset, String lang) {
    ...
    if (null == wdh.getExolexFeatureBox(ExtractionFeature.MAIN) && !"ltv".equals(lang))
      return;
